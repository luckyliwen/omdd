...
sap.ui.core.Control.extend("fd.uilib.FileChoose", {
	metadata : {
		...
		//here name to buttonControl just in order to keep the old interface
		aggregations: {
			'button': {type : "sap.ui.core.Control",  multiple : true}
		}, 
	...
	renderer : function(oRm, oControl) {
		...
		//first the button
		oRm.renderControl( oControl.getAggregation("button")[0] );
...
fd.uilib.FileChoose.prototype.onAfterRendering = function() {
	...
	var btn = this.getAggregation("button")[0];
